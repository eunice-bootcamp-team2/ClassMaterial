...
---
설치: macOS / Linux / WSL 공통 (이미 설치 되었으므로 패스)
```bash
curl -LsSf https://astral.sh/uv/install.sh | sh
```

설치버전 확인 (설치되었는지 버전만 확인합니다.)
```bash
uv --version
```
...
---
방법1: URL 그대로 복사해서 접속
![[Pasted image 20260205141531.png]]

방법2: 로그인 화면에서 토큰 붙여넣기
![[Pasted image 20260205141646.png]]
- 터미널 주소에서 `token=` 뒤에 있는 긴 문자열만 복사
```
b1944f390af040fce95ddd948b3f0b199528750e2cc37960
```
- 로그인 화면의  
    Password or token 칸에 붙여넣기
- Log in 클릭
...
Jupyter Notebook이 실행 중일 때 어디서, 어떤 주소로 실행되고 있는지를 확인하는 명령어
```bash
jupyter server list
```
...
---
새 파일 생성:
![[Pasted image 20260205142154.png]]
