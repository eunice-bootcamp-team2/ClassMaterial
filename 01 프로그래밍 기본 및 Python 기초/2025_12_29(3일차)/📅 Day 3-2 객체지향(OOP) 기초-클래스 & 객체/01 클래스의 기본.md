...
print(f"이름: {s2.name}, 점수: {s2.score}")
```
...
class Student:
    def __init__(self, name, scores):
        self.name = name # 민지
        self.scores = scores # [80, 90, 85]

    def get_sum(self):
        return sum(self.scores) # 총점

    def get_avg(self):
        return sum(self.scores) / len(self.scores) # 평균

s1 = Student("민지", [80, 90, 85])
print(f"총점: {s1.get_sum}와 평균은 ")
print("평균:", s1.get_avg())
```
