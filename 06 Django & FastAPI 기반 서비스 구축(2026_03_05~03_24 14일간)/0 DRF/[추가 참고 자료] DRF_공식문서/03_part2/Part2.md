...
![[기타/image7-8/Pasted image 20250608173152.png]]

`urlpatterns = format_suffix_patterns(urlpatterns)` 있을때
![[기타/image7-8/Pasted image 20250608173245.png]]
...
![[기타/image7-8/Pasted image 20250615225353.png]]
이 코드를 추가하면, 다음처럼 URL 끝에 포맷을 명시할 수 있습니다:

Insomnia에는 기본 설정되어 있으나 삭제가능 합니다.
![[기타/image7-8/Pasted image 20250608173357.png]]
...
```
![[기타/image7-8/Pasted image 20250608165731.png]]
...
```
![[기타/image7-8/Pasted image 20250608165955.png]]
